...
<head>
  <meta charset="UTF-8">
  <title>Image to PDF Converter (500 Pages)</title>
  ...
  <style>
    ...
    .main { margin-left: 250px; margin-top: 80px; padding: 25px; flex: 1; transition: margin-left 0.3s ease; } 
...
<body>
  ...
  <h2>🖼️ Image to PDF Converter (Supports 500 Images)</h2>
